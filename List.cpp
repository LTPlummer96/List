...
template <typename Object>
typename List<Object>::List &List<Object>::operator=(const typename List<Object>::List &rhs)
{
  List copy = rhs;
  std::swap(*this, copy);
  return *this;
...
template <typename Object>
typename List<Object>::List &List<Object>::operator=(typename List<Object>::List &&rhs)
{
